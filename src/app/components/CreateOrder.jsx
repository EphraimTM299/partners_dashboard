    ...
    async function sendData (bankName, accountNumber, branchCode, accountType) {
      ...
      const laundryType = [
        ...
        },
        {
          ...
          value: "38",
          serviceName:"Wash,Dry,Fold & Iron"
        },
        {
          label: "Iron Only",
          value: "30",
      ...
      const dryClean = [
        ...
        },
        {
          ...
          value: "100",
            ...
            <div className='flex justify-start px-7 pt-4'>
            
            <button onClick={onCreateNewOrder} className="text-white mt-6 ml-2 bg-blue-700 block hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">New Order </button>
            ...
            <div className='m-5 flex font-semibold justify-between  '>
                ...
                <GiCancel className='mt-2 mr-2' onClick={onCancelNewOrder} size={30}/>
            </div>
         
            <div className="overflow-hidden px-8 py-8 bg-white justify-center flex flex-wrap rounded-lg border border-gray-200 shadow-md">
                    ...
                    <form className='px-4 py-10 w-full sm:w-1/2'>
                            ...
                            {isLaundry == 'Laundry' && 
                            <div>
                                    <label htmlFor="visitors" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Enter Weight(kg)</label>
                                    <input onChange={e=> updateWeight(+e.target.value)} min={0} type="number" id="visitors" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" defaultValue={0} placeholder="" required/>
                                ...
                                {isLaundry == 'Laundry' && <div > 
                                    ...
                                    <select onChange={ e => {
                                        // setBasket(e.target.serviceName)
                                        updateLaundryP(+e.target.value)}}  className=' bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" ' name="" id="">
                                    ...
                                    <button type='button'    
                                        ...
                                        setBasket([
                                          ...basket,
                                          { id: nextId++, name: serviceName , weight :weight}
                                        ]);
                                      }}
                                    
                                    className="text-white mt-6  bg-blue-700 block hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Add to Basket </button>
                                   {console.log(basket)}
                                </div>}
                            ...
                            {isLaundry == 'Dry Cleaning' && <div> 
                                    ...
                                    <button className="text-white mt-6 bg-blue-700 block hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Add to Order
                                    </button>
                            </div>
                            ...
                            <button type="submit"  disabled={isButtonDisabled} className= {isButtonDisabled? "text-white mt-6 bg-gray-300 block focus:outline-none font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center" :"text-white mt-6 bg-blue-700 block hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"}>Create Order</button>

                        </form>
                        <div className='bg-white ml-8 px-10 py-8 mt-5  justify-center' >
                           <ul>  {
                            basket.map((basketItems, index)=>(
                                <li key={basketItems.id}>{basketItems.name}</li>
